    ...
    <div className="max-w-2xl mx-auto w-full px-4 py-12 space-y-6">
      ...
      <div className="bg-white shadow-xl rounded-lg p-8 border border-gray-100">
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {formData.education.map((edu, idx) => (
              ...
              >
                ...
                <input
                  ...
                  value={edu.gpa}
                  onChange={(e) =>
                    handleNestedChange("education", idx, "gpa", e.target.value)
                  }
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                />
          ...
          {/* Thesis Abstract */}
          <div>
            <label className="block font-medium mb-2">Thesis Abstract</label>
            <textarea
              placeholder="Enter thesis abstract"
              value={formData.thesisAbstract}
              onChange={(e) => handleChange("thesisAbstract", e.target.value)}
          ...
          <div>
            ...
            <button
              type="button"
              onClick={() =>
                handleAddField("experience", { title: "", description: "" })
              }
              className="text-blue-600 hover:text-blue-800 transition text-sm"
            >
              + Add Experience
